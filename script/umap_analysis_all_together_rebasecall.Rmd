...
### Sockeye pipeline
![UAMP from Sockeye pipeline](fig/sockeye_umap_q20.png)
...
### Sockeye pipeline
![UAMP from Sockeye pipeline](fig/sockeye_umap_nonq20.png)
...
### Compare the clusters among BLAZE, Sockeye and Cellranger coloured by BLAZE
With the UMAP plots above, I colored cells in BLAZE or Sockeye plot based on the clusters identified in Cellranger result.
```{r, message=FALSE, warning=FALSE, fig.width=15,fig.height = 6}
# cell Ranger    
