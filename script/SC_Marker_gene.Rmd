...
# Cellranger
plots <- plot_umap(gene_C_nonq20_pmth, min.features = 200,max.feature = 999999999, npc = 5, cluster_res = 0.7,fig_name = 'Cellranger+FLAME (Gene Counts, Q20 data)')

umap_object_C <- plots[[2]]

#Find MArkers 
markers <- FindAllMarkers(object = umap_object_C, 
                          only.pos = TRUE,
